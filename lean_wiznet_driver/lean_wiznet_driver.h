...
#ifndef _LEAN_WIZNET_
#define _LEAN_WIZNET_
...
#define W5500_CHIP_VERSION 0x0039 /* Chip version register */
...
#define W5500_S0_RX_RSR		(W5500_S0_REGS + W5500_Sn_RX_RSR) // Socket n RX Received Size
#define W5500_S0_RX_RD		(W5500_S0_REGS + W5500_Sn_RX_RD)  // Socket n RX Read Pointer
...
struct LeanWiznet_runtime {
	// struct net_if *iface;
	K_KERNEL_STACK_MEMBER(rx_thread_stack, LEAN_WIZNET_THREAD_STACK_SIZE); // JON pound define
	K_KERNEL_STACK_MEMBER(tx_thread_stack, LEAN_WIZNET_THREAD_STACK_SIZE); // JON pound define
