...
LOG_MODULE_REGISTER(dect_adapter, LOG_LEVEL_WRN);
...
static void internal_op_functional_mode_cb(struct nrf_modem_dect_mac_control_functional_mode_cb_params *params)
{
...
static void internal_op_configure_cb(struct nrf_modem_dect_mac_control_configure_cb_params *params)
{
...
static void internal_op_systemmode_cb(struct nrf_modem_dect_mac_control_systemmode_cb_params *params)
{
...
static void internal_op_cluster_configure_cb(struct nrf_modem_dect_mac_cluster_configure_cb_params *params)
{
...
static void internal_op_cluster_beacon_receive_cb(struct nrf_modem_dect_mac_cluster_beacon_receive_cb_params *params)
{
...
static void internal_op_cluster_beacon_receive_stop_cb(struct nrf_modem_dect_mac_cluster_beacon_receive_stop_cb_params *params)
{
...
static void internal_op_network_beacon_configure_cb(struct nrf_modem_dect_mac_network_beacon_configure_cb_params *params)
{
...
static void internal_op_network_scan_cb(struct nrf_modem_dect_mac_network_scan_cb_params *params)
{
...
static void internal_op_network_scan_stop_cb(struct nrf_modem_dect_mac_network_scan_stop_cb_params *params)
{
...
static void internal_op_rssi_scan_cb(struct nrf_modem_dect_mac_rssi_scan_cb_params *params)
{
...
static void internal_op_rssi_scan_stop_cb(struct nrf_modem_dect_mac_rssi_scan_stop_cb_params *params)
{
...
static void internal_op_dlc_data_tx_cb(struct nrf_modem_dect_dlc_data_tx_cb_params *params)
{
...
static void internal_op_dlc_data_discard_cb(struct nrf_modem_dect_dlc_data_discard_cb_params *params)
{
  LOG_DBG("op dlc_data_discard callback: status=%d txn=%u flow=%u rd=%u", params->status, params->transaction_id, params->flow_id, params->long_rd_id);
  LOG_INF("op dlc_data_discard callback: status=%d txn=%u flow=%u rd=%u", params->status, params->transaction_id, params->flow_id, params->long_rd_id);
}

static void internal_op_association_release_cb(struct nrf_modem_dect_mac_association_release_cb_params *params)
{
  LOG_DBG("op association_release callback: rd=%u", params->long_rd_id);
}

static void internal_op_cluster_info_cb(struct nrf_modem_dect_mac_cluster_info_cb_params *params)
{
  LOG_DBG("op cluster_info callback: status=%d", params->status);
}

static void internal_op_neighbor_info_cb(struct nrf_modem_dect_mac_neighbor_info_cb_params *params)
{
  LOG_DBG("op neighbor_info callback: status=%d rd=%u", params->status, params->long_rd_id);
}

static void internal_op_neighbor_list_cb(struct nrf_modem_dect_mac_neighbor_list_cb_params *params)
{
...
static void internal_op_association_cb(struct nrf_modem_dect_mac_association_cb_params *params)
{
...
static void internal_ntf_association_release_cb(struct nrf_modem_dect_mac_association_release_ntf_cb_params *params)
{
...
static void internal_ntf_rssi_scan_cb(struct nrf_modem_dect_mac_rssi_scan_ntf_cb_params *params)
{
...
static void internal_ntf_cluster_beacon_cb(struct nrf_modem_dect_mac_cluster_beacon_ntf_cb_params *params)
{
...
static void internal_ntf_cluster_beacon_rx_failure_cb(struct nrf_modem_dect_mac_cluster_beacon_rx_failure_ntf_cb_params *params)
{
...
static void internal_ntf_network_beacon_cb(struct nrf_modem_dect_mac_network_beacon_ntf_cb_params *params)
{
  uint32_t period_ms = cluster_beacon_period_to_ms(params->beacon.cluster_beacon_period);
  beacon_period_ms = period_ms;
...
static void internal_ntf_dlc_data_rx_cb(struct nrf_modem_dect_dlc_data_rx_ntf_cb_params *params)
{
  LOG_INF("ntf dlc_data_rx callback: rd=%u flow=%u len=%zu", params->long_rd_id, params->flow_id, params->data_len);
...
static void internal_ntf_cluster_ch_load_change_cb(struct nrf_modem_dect_mac_cluster_ch_load_change_ntf_cb_params *params)
{
  LOG_DBG("ntf cluster_ch_load_change callback: ch=%u busy=%u%%",
          params->rssi_result.channel, params->rssi_result.busy_percentage);
}

static void internal_ntf_neighbor_inactivity_cb(struct nrf_modem_dect_mac_neighbor_inactivity_ntf_cb_params *params)
{
  LOG_DBG("ntf neighbor_inactivity callback: rd=%u", params->long_rd_id);
}

static void internal_ntf_neighbor_paging_failure_cb(struct nrf_modem_dect_mac_neighbor_paging_failure_ntf_cb_params *params)
{
  LOG_DBG("ntf neighbor_paging_failure callback: rd=%u", params->long_rd_id);
}

static void internal_ntf_ipv6_config_update_cb(struct nrf_modem_dect_mac_ipv6_config_update_ntf_cb_params *params)
{
  ARG_UNUSED(params);
  LOG_DBG("ntf ipv6_config_update callback");
}

static void internal_ntf_capability_cb(struct nrf_modem_dect_mac_capability_ntf_cb_params *params)
{
...
static void internal_ntf_dlc_flow_control_cb(struct nrf_modem_dect_dlc_flow_control_ntf_cb_params *params)
{
