...
# Workflow:
- Lets say it's been a while since you looked at this stuff. you sat down you want to do DECT NR + work. you do the following:
...
- `nrfutil sdk-manager install v3.2.0` # this will take a bit if we need to download
- `west init -m https://github.com/nrfconnect/sdk-nrf --mr v3.2.0-rc2 ./sdk-nrf` # initializes west, zephyr's build utility, against v3.2.0-rc2 version nrf sdk, puts it into the current dir you are in, names it sdk-nrf
